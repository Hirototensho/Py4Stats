...
```
![scaling_up_regression1.png](image/scaling_up_regression1.png)
## グループ別の回帰分析
...
for k, mod in enumerate(list_fitted2):
  ...
  ax[k].set_xlabel(f'coefficient (n = {mod.nobs:,.0f})')
```
![scaling_up_regression2.png](image/scaling_up_regression2.png)
...
```
![scaling_up_regression3.png](image/scaling_up_regression3.png)
