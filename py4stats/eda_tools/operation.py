...
def compare_df_cols(
    ...
    # 引数のアサーション ----------------------
    _ = eda_utils.as_nw_datarame(df_list)
...
def compare_df_record(
    ...
    """
    df1 = eda_utils.as_nw_datarame(df1, arg_name = 'df1')
...
def compare_group_means(
    ...
    # ==============================================================
    group1 = eda_utils.as_nw_datarame(group1, arg_name = 'group1')
    group2 = eda_utils.as_nw_datarame(group2, arg_name = 'group2')
    group1 = remove_constant(group1, to_native = False)
    group2 = remove_constant(group2, to_native = False)

    # 平均値の計算 =========================================================
    stats_df1 = eda_utils.enframe(
...
def compare_group_median(
    ...
    # ==============================================================
    group1 = eda_utils.as_nw_datarame(group1, arg_name = 'group1')
    group2 = eda_utils.as_nw_datarame(group2, arg_name = 'group1')
    group1 = remove_constant(group1, to_native = False)
    group2 = remove_constant(group2, to_native = False)
...
def filtering_out(
    ...
    *args: Union[str, List[str], narwhals.Expr, narwhals.selectors.Selector], 
    ...
    eda_utils._assert_selectors(*args, arg_name = 'args', nullable = True)
    # ==============================================================
    data_nw = eda_utils.as_nw_datarame(data)
...
def relocate(
    ...
    # 引数のアサーション ======================================
    build.assert_logical(to_native, arg_name = 'to_native')
    eda_utils._assert_selectors(*args)
...
def group_split(
    ...
    """
    # 引数のアサーション =======================================================
    eda_utils._assert_selectors(*group_cols, arg_name = 'args')
...
def group_modify(
    ...
    # ========================================================================
    impl = eda_utils.as_nw_datarame(data).implementation
    ...
    list_result2 = [
        ...
        else eda_utils.enframe(v, backend = impl, to_native = False)
...
def bind_rows_df(
    ...
    # 引数のアサーション =======================================================
    args = list(build.list_flatten(args))
    args = eda_utils.as_nw_datarame_list(args, arg_name = 'args')
    eda_utils._assert_unique_backend(args)
...
def bind_rows_dict(
    ...
    **keywargs
    ...
    args = eda_utils.as_nw_datarame_dict(args, arg_name = 'args')
    eda_utils._assert_unique_backend(args.values())
    build.assert_character(id, arg_name = 'id', len_arg = 1, nullable = True)
    # =======================================================================
    if id is None: 
